...
##     tener un script de Python (your_scri2.pt.py) que quieras ejecutar en Streamlit.
...
st.markdown("<h1 style='text-align: center;'>Gather Step</h1>", unsafe_allow_html=True)
...
texto = """
Soy Mateo Laos, estudio comunicación audiovisual, lo que me gusta de mi carrera es principalmente la fotografía y la edición. 
-	En el futuro me gustaría ser fotógrafo deportivo y de conciertos, trabajar en la creación de producciones audiovisuales, especializándome en la parte creativa y la edición.
-	En mi tiempo libre suelo tocar con mi banda y jugar baloncesto.
"""
...
texto_2 = """
-	Cuando inicié a programar me sentí un poco asustado, debido a que pensé que se me complicaría mucho, y no creí ver programación en esta carrera, sin embargo, a lo largo del curso, pude mejorar y entender que no era tan difícil como parecía, solo era cuestión de práctica. Lo que no me gusta de programar es que, si cometes un mínimo error en el código, este no se ejecuta. Finalmente, lo que me gustaría hacer con la programación en el futuro sería crear páginas web para las bandas de la escena nacional, en la que se muestren sus próximos shows, equipo que utiliza cada integrante, etc. 
"""
...
sidebar.markdown("<h1 style='text-align: center;'>Gráficos que realicé a lo largo del ciclo</h1>", unsafe_allow_html=True)
...
graficos = ['Verona e Inter', 'Promedio de tarjetas', 'Goles de la Juventus']
...
if grafico_seleccionado == 'Verona e Inter':
    sidebar.markdown("<div style='text-align: justify; font-size: 20px;'>Comparación del promedio de goles como visitante entre Verona e Inter</div>", unsafe_allow_html=True)
    sidebar.image("goles1.png", caption='Verona e Inter', width=500)
    pass
elif grafico_seleccionado == 'Promedio de tarjetas':
    sidebar.markdown("<div style='text-align: justify'>Promedio ed tarjetas recibidas por cada equipo.</div>", unsafe_allow_html=True)
    sidebar.image("gráfico2.png", caption='Promedio de tarjetas', width=500)
    pass
elif grafico_seleccionado == 'Goles de la Juventus':
    sidebar.markdown("<div style='text-align: justify'>Comparación de goles como local y visitante de la Juventus.</div>", unsafe_allow_html=True)
    sidebar.image("gráfico3.png", caption='Goles de la Juventus', width=500)
    pass
